    ...
    const arts = props.rows.map((row, i) => {
        ...
        return (
            <tr key={i}>
                ...
                <td>
                    <button type="button" class="btn btn-outline-success ms-3" onClick={e=>updateArticleStatus(e,row.idVersion,5)} >
                    ...
                    <button type="button" class="btn btn-outline-danger ms-3"  onClick={e=>updateArticleStatus(e,row.idVersion,3)}>
                    ...
                    <button type="button" class="btn btn-outline-warning ms-3"  onClick={e=>updateArticleStatus(e,row.idVersion,4)}>
